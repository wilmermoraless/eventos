 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vt=new To("@firebase/app"),xc="@firebase/app-compat",Rc="@firebase/analytics-compat",Mc="@firebase/analytics",Oc="@firebase/app-check-compat",Lc="@firebase/app-check",Fc="@firebase/auth",Pc="@firebase/auth-compat",Vc="@firebase/database",$c="@firebase/database-compat",Uc="@firebase/functions",Bc="@firebase/functions-compat",jc="@firebase/installations",qc="@firebase/installations-compat",zc="@firebase/messaging",Hc="@firebase/messaging-compat",Kc="@firebase/performance",Gc="@firebase/performance-compat",Qc="@firebase/remote-config",Wc="@firebase/remote-config-compat",Xc="@firebase/storage",Yc="@firebase/storage-compat",Jc="@firebase/firestore",Zc="@firebase/firestore-compat",th="firebase",eh="9.21.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yd{constructor(t,n){this.Ms={},this.overlays={},this.Os=new Mr(0),this.$s=!1,this.$s=!0,this.referenceDelegate=t(this),this.Fs=new Xd(this),this.indexManager=new Ud,this.remoteDocumentCache=function(s){return new Qd(s)}(s=>this.referenceDelegate.Bs(s)),this.serializer=new Vd(n),this.Ls=new Hd(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.$s=!1,Promise.resolve()}get started(){return this.$s}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let n=this.overlays[t.toKey()];return n||(n=new Kd,this.overlays[t.toKey()]=n),n}getMutationQueue(t,n){let s=this.Ms[t.toKey()];return s||(s=new Gd(n,this.referenceDelegate),this.Ms[t.toKey()]=s),s}getTargetCache(){return this.Fs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ls}runTransaction(t,n,s){v("MemoryPersistence","Starting transaction:",t);const r=new Jd(this.Os.next());return this.referenceDelegate.qs(),s(r).next(i=>this.referenceDelegate.Us(r).next(()=>i)).toPromise().then(i=>(r.raiseOnCommittedEvent(),i))}Ks(t,n){return f.or(Object.values(this.Ms).map(s=>()=>s.containsKey(t,n)))}}class Jd extends Pl{constructor(t){super(),this.currentSequenceNumber=t}}class Kr{constructor(t){this.persistence=t,this.Gs=new Hr,this.Qs=null}static js(t){return new Kr(t)}get zs(){if(this.Qs)return this.Qs;throw E()}addReference(t,n,s){return this.Gs.addReference(s,n),this.zs.delete(s.toString()),f.resolve()}removeReference(t,n,s){return this.Gs.removeReference(s,n),this.zs.add(s.toString()),f.resolve()}markPotentiallyOrphaned(t,n){return this.zs.add(n.toString()),f.resolve()}removeTarget(t,n){this.Gs.ps(n.targetId).forEach(r=>this.zs.add(r.toString()));const s=this.persistence.getTargetCache();return s.getMatchingKeysForTargetId(t,n.targetId).next(r=>{r.forEach(i=>this.zs.add(i.toString()))}).next(()=>s.removeTargetData(t,n))}qs(){this.Qs=new Set}Us(t){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return f.forEach(this.zs,s=>{const r=w.fromPath(s);return this.Ws(t,r).next(i=>{i||n.removeEntry(r,S.min())})}).next(()=>(this.Qs=null,n.apply(t)))}updateLimboDocument(t,n){return this.Ws(t,n).next(s=>{s?this.zs.delete(n.toString()):this.zs.add(n.toString())})}Bs(t){return 0}Ws(t,n){return f.or([()=>f.resolve(this.Gs.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(t,n),()=>this.persistence.Ks(t,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
